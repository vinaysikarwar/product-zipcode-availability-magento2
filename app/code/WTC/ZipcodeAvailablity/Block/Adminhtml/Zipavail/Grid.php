<?php
namespace WTC\ZipcodeAvailablity\Block\Adminhtml\Zipavail;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    /**
     * @var \WTC\ZipcodeAvailablity\Model\zipavailFactory
     */
    protected $_zipavailFactory;
    protected $_countryCollectionFactory;
    /**
     * @var \WTC\ZipcodeAvailablity\Model\Status
     */
    protected $_status;
     ...
     * @param \WTC\ZipcodeAvailablity\Model\zipavailFactory $zipavailFactory
     * @param \WTC\ZipcodeAvailablity\Model\Status $status
    ...
    public function __construct(
        ...
        \WTC\ZipcodeAvailablity\Model\ZipavailFactory $ZipavailFactory,
        \WTC\ZipcodeAvailablity\Model\Status $status,
                ...
                'column_css_class' => 'col-id'
				  ...
				  $this->addColumn(
							...
							[
								...
								'index' => 'country',
								'type' => 'options',
								//'options' => \WTC\ZipcodeAvailablity\Block\Adminhtml\Zipavail\Grid::getOptionArray5()
    ...
    protected function _prepareMassaction()
    {
        ...
        //$this->getMassactionBlock()->setTemplate('WTC_ZipcodeAvailablity::zipavail/grid/massaction_extended.phtml');
    ...
    /**
     * @param \WTC\ZipcodeAvailablity\Model\zipavail|\Magento\Framework\Object $row
     * @return string
     */
    public function getRowUrl($row)
    {
		...
		{
            $data_array=array();
			foreach(\WTC\ZipcodeAvailablity\Block\Adminhtml\Zipavail\Grid::getOptionArray5() as $k=>$v){
